...
pub enum Arphrd {
    ...
    Slip = libc::ARPHRD_SLIP,
    Cslip = libc::ARPHRD_CSLIP,
    Slip6 = libc::ARPHRD_SLIP6,
    Cslip6 = libc::ARPHRD_CSLIP,
    Rsrvd = libc::ARPHRD_RSRVD,
    Adapt = libc::ARPHRD_ADAPT,
    Rose = libc::ARPHRD_SLIP,
    X25 = libc::ARPHRD_X25,
    Hwx25 = libc::ARPHRD_HWX25,
    Can = libc::ARPHRD_CAN,
    Ppp = libc::ARPHRD_PPP,
    Cisco = libc::ARPHRD_CISCO,
    Hdlc = libc::ARPHRD_HDLC,
    Lapb = libc::ARPHRD_LAPB,
    Ddcmp = libc::ARPHRD_DDCMP,
    Rawhdlc = libc::ARPHRD_RAWHDLC,

    Tunnel = libc::ARPHRD_TUNNEL,
    Tunnel6 = libc::ARPHRD_TUNNEL6,
    Frad = libc::ARPHRD_FRAD,
    Skip = libc::ARPHRD_SKIP,
    Loopback = libc::ARPHRD_LOOPBACK,
    Localtlk = libc::ARPHRD_LOCALTLK,
    Fddi = libc::ARPHRD_FDDI,
    Bif = libc::ARPHRD_BIF,
    Sit = libc::ARPHRD_SIT,
    Ipddp = libc::ARPHRD_IPDDP,
    Ipgre = libc::ARPHRD_IPGRE,
    Pimreg = libc::ARPHRD_PIMREG,
    Hippi = libc::ARPHRD_HIPPI,
    Ash = libc::ARPHRD_ASH,
    Econet = libc::ARPHRD_ECONET,
    Irda = libc::ARPHRD_IRDA,
    Fcpp = libc::ARPHRD_FCPP,
    Fcal = libc::ARPHRD_FCAL,
    Fcpl = libc::ARPHRD_FCPL,
    Fcfabric = libc::ARPHRD_FCFABRIC,
    Ieee802Tr = libc::ARPHRD_IEEE802_TR,
    Ieee80211 = libc::ARPHRD_IEEE80211,
    Ieee80211Prism = libc::ARPHRD_IEEE80211_PRISM,
    Ieee80211Radiotap = libc::ARPHRD_IEEE80211_RADIOTAP,
    Ieee802154 = libc::ARPHRD_IEEE802154,
